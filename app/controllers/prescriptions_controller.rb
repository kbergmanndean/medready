class PrescriptionsController < ApplicationController
    ...
    def create
        # new_script=Prescription.create(script_params, user_id:params[:user_id])
    ...
    private
    def script_params
        params.require(:prescription).permit(:user_id, :medication_id, :doctor_id, :daily_dosage, :directions, :doses_in_container)
    end
end
