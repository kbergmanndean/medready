...
useEffect(() => {
  async function fetchMedData() {
    const res = await fetch("https://ancient-coast-67474.herokuapp.com/https://medready.herokuapp.com/medications");
    const medData = await res.json();
    setMeds(medData);
  }
  async function fetchDocData() {
    const res = await fetch("https://ancient-coast-67474.herokuapp.com/https://medready.herokuapp.com/doctors");
    const docData = await res.json();
    setDoctors(docData);
  }
  async function fetchPreData(){
    const res=await fetch("https://ancient-coast-67474.herokuapp.com/https://medready.herokuapp.com/prescriptions")
